...
do
  case ${1%:*} in
    ...
    'run')
      ...
      docker run --name $GRAFANA_NAME --link $INFLUX_NAME:$INFLUX_NAME -d -p 8091:8080 -e INFLUXDB_URL="http://$INFLUX_NAME:8086" -e DB_NAME=$INFLUX_DATABASE ekino/grafana:latest
